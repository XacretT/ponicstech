          ...
          <div className="col-auto g-pos-rel">
            <ul className="list-inline g-overflow-hidden g-pt-1 g-mx-minus-4 mb-0">
              <li className="list-inline-item g-mx-4">
                ...
                <a href="#" id="languages-dropdown-invoker-2" className="g-color-white g-color-primary--hover g-text-underline--none--hover" aria-controls="languages-dropdown-2" aria-haspopup="true" aria-expanded="false" data-dropdown-event="click" data-dropdown-target="#languages-dropdown-2" data-dropdown-type="css-animation" data-dropdown-duration="{300}" data-dropdown-hide-on-scroll="false" data-dropdown-animation-in="fadeIn" data-dropdown-animation-out="fadeOut">
Язык
                </a>
          ...
          <div className="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg" id="navBar">
            <ul className="navbar-nav text-uppercase g-font-weight-600 ml-auto">
              ...
              <li className="nav-item g-mx-20--lg">
                <Link to="/" className="nav-link px-0">Главная</Link>
                
              </li>
              <li className="nav-item g-mx-20--lg">
                <Link to="/products/" className="nav-link px-0">Продукты</Link>
              ...
              <li className="nav-item g-mx-20--lg">
                ...
                <Link to="/company/" className="nav-link px-0">Компания</Link>
...
Blog
              ...
              <li className="nav-item g-mx-20--lg">
                <Link to="/contactus/" className="nav-link px-0">Контакты</Link>
