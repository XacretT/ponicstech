...
import assembly1 from './htype/assembly1.png'
import trayassembly from './htype/tray-assembly.png'
    ...
    return (
      <Layout>
        <div className="index-container">
          <Helmet title="H-Type Multi-Tiered Aeroponic Systems - Ponics Technologies" />
      ...
      <div className="container g-pt-100">
        <div className="row justify-content-between">
          <div className="col-md-5 align-self-center">
            <h2 className="g-color-black g-font-size-36 text-uppercase g-line-height-1_2 g-mb-30">
Revolution in Growing
              <br />
              <span className="g-font-weight-700">H-Type Installation</span>
            </h2>
            <p className="g-color-gray-dark-v5 g-font-size-16 g-mb-35">Optimal conditions for growing greens, determinate plants and microgreens</p>
          </div>
        ...
        <div className="tab-pane fade show active" id="nav-8-1-accordion-primary-hor-center--1" role="tabpanel">
          ...
          <section className="container">
            <div className="text-center g-pb-50 g-pt-50">
              <h2 className="h1 g-color-black g-font-weight-700 mb-4">Multi-tiered Installation</h2>
              <p className="lead mb-0">
H-type installation are a unique development of Ponics Technologies. These systems are designed and optimized to create optimal conditions for growing plants. Pre-designed flexibility allows you to grow greens, variety of determinant plants and micro-greens.
              <br />
              <br />
Installations of this type can be made to order with any dimensional characteristics and number of tiers
            </p>
            </div>
            ...
            <section className="container g-pt-100 g-pb-40">
              ...
              <h2 className="h3 text-uppercase g-font-weight-300 u-heading-v2__title">Flexible plant tray</h2>
              <div className="d-inline-block g-width-35 g-height-1 g-bg-gray-dark-v5 mb-2" />
              <p className="mb-2">Grow anything from lettuce to tomatoes</p>
            </div>
              {/* End Heading */}
              <div className="row justify-content-between">
              ...
              <div className="g-mb-30">
                ...
                <p className="g-color-gray-dark-v4">Up to 3 covers with different opening's diameter and frequency can be installed on the pallet and, accordingly, the number of planted plants</p>
              </div>
              {/* End Icon Blocks */}
              {/* Icon Blocks */}
            ...
            <section className="g-flex-centered g-height-450 g-py-30 g-mt-100">
              ...
              <div className="col-md-6">
                ...
                <div className="sketchfab-embed-wrapper">
                  <iframe width={600} height={380} src="https://sketchfab.com/models/1189d7b8b90f4ae8b0d2115b7e2b3595/embed" frameBorder={0} allowvr allowFullScreen mozallowfullscreen="true" webkitallowfullscreen="true" onmousewheel />
                  {' '}
                </div>
          ...
          <div className="container">
            <div className="table-responsive">
              ...
              <tr>
                ...
                <td className="align-middle">1400 mm (55,12 inch) </td>
              </tr>
              <tr>
                <td className="align-middle text-nowrap">
                  <h4 className="h6 g-mb-2">Depth</h4>
                </td>
                <td className="align-middle">750 mm (30 inch)</td>
              </tr>
              <tr>
                <td className="align-middle text-nowrap">
                  <h4 className="h6 g-mb-2">Height</h4>
                </td>
                <td className="align-middle">base 2000 mm (78.75 inch)</td>
              </tr>
              <tr>
                <td className="align-middle text-nowrap">
                  <h4 className="h6 g-mb-2">Plants in a row</h4>
                </td>
                <td>84 unit (55 mm distance, suitable for lettuce, basil, arugula etc)</td>
              </tr>
              <tr>
                <td className="align-middle text-nowrap">
              ...
              <tr>
                ...
                <td className="align-middle">Water-nutrient mixture spray</td>
              </tr>
              <tr>
                <td className="align-middle text-nowrap">
